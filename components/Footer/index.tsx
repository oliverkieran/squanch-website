        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              >
                <a href="/" className="relative">
                  <Image
                    width={110}
                    height={80}
                    src="/images/logo/navbar-logo.svg"
                    alt="Logo"
                  ...
                  <Image
                    width={110}
                    height={80}
                    src="/images/logo/navbar-logo-dark.svg"
                    alt="Logo"
                ...
                <p className="mt-5 mb-10">
                  Helping you to diversify the sports commentary landscape.
                </p>
          ...
          <div className="border-t border-stroke dark:border-strokedark flex flex-wrap flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 lg:gap-0 py-7">
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; 2023 Squanch. All rights reserved</p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://x.com/squanchsports">
                    <svg
                ...
                <li>
                  <a href="https://linkedin.com/company/squanch">
                    <svg
                      className="fill-[#D1D8E0] hover:fill-primary transition-all duration-300"
                      width="24"
                      height="24"
